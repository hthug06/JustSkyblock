...
public class IslandListByYAML {
    ...
    public void createIsland(String id){
        ...
        map1.put("Block", String.valueOf(SkyblockPlugin.getInstance().getConfig().get("IS." + id + "." + "Block")));

        map1.put("Name", String.valueOf(SkyblockPlugin.getInstance().getConfig().get("IS." + id + "." + "Name")));

        map1.put("Schematic", String.valueOf(SkyblockPlugin.getInstance().getConfig().get("IS." + id + "." + "Schematic")));

        map1.put("Slot", String.valueOf(SkyblockPlugin.getInstance().getConfig().get("IS." + id + "." + "Slot")));
